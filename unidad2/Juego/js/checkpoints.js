    ...
    "questions": [
      {
        ...
        "type": "mcq",
        "difficulty": 2,
        "prompt": "Un móvil parte de \\(x=2\\,\\mathrm{m}\\), llega a \\(x=8\\,\\mathrm{m}\\) y luego vuelve a \\(x=5\\,\\mathrm{m}\\). ¿Qué afirmación es correcta?",
        "options": [
          "La distancia recorrida es 9 m y el desplazamiento es +3 m.",
          "La distancia y el desplazamiento valen 3 m.",
          "La distancia es 3 m y el desplazamiento 9 m.",
          "El desplazamiento es −3 m."
        ],
        "answer": "A",
        "explanation": "Recorre 6 m hacia adelante y 3 m hacia atrás: distancia 9 m. El cambio neto es \\(5-2=+3\\,\\mathrm{m}\\)."
      },
      {
        "id": "CP_FUND_002",
        "type": "mcq",
        ...
        "options": [
          "La velocidad es negativa y su módulo aumenta.",
          "La velocidad es positiva y constante.",
          "El móvil está en reposo.",
          "La aceleración debe ser cero."
        ],
        "answer": "A",
      ...
      },
      {
        ...
        "options": [
          "La velocidad vectorial y la aceleración.",
          "La rapidez y el tiempo necesariamente.",
          "La masa y la distancia por definición.",
          "Ninguna, porque la rapidez es constante."
        ],
        "answer": "A",
      ...
      },
      {
        ...
        "options": [
          "Su coordenada de posición, pero no su ubicación física.",
          "Su velocidad física necesariamente.",
          "Su masa.",
          "La gravedad local."
        ],
        "answer": "A",
      ...
      },
      {
        ...
        "options": [
          "Rapidez media = 10 m/s; velocidad media = 0.",
          "Rapidez media = 0; velocidad media = 10 m/s.",
          "Ambas valen 10 m/s.",
          "Ambas valen 0."
        ],
        "answer": "A",
    ...
    "questions": [
      {
        ...
        "type": "mcq",
        "difficulty": 2,
        "prompt": "Una cinta parte del reposo y llega a \\(1.2\\,\\mathrm{m/s}\\) en \\(4\\,\\mathrm{s}\\) con aceleración constante. ¿Cuál es su aceleración?",
        "options": [
          "0.30 m/s²",
          "4.8 m/s²",
          "1.2 m/s²",
        ...
        "answer": "A",
        "explanation": "\\(a=\\frac{\\Delta v}{\\Delta\\,t}=1.2/4=0.30\\,\\mathrm{m/s^2}\\)."
      },
      {
        "id": "CP_RECT_002",
        "type": "mcq",
        "difficulty": 3,
        "prompt": "Un móvil frena desde \\(10\\,\\mathrm{m/s}\\) con \\(a=-2\\,\\mathrm{m/s^2}\\). ¿Qué distancia necesita para detenerse?",
        "options": [
          "25 m",
          "20 m",
          "50 m",
        ...
        "answer": "A",
        "explanation": "Con \\(v_f^2=v_0^2+2a\\Delta x\\): \\(0=100-4\\Delta x\\), por lo que \\(\\Delta x=25\\,\\mathrm{m}\\)."
      },
      {
        "id": "CP_RECT_003",
        "type": "mcq",
        ...
        "answer": "A",
        "explanation": "La pendiente es \\(\\frac{dv}{dt}=a\\) y el área bajo v(t) es el desplazamiento."
      },
      {
        "id": "CP_RECT_004",
        "type": "mcq",
        ...
        "options": [
          "\\(v_y=0\\) pero \\(a_y=-g\\) si y es positivo hacia arriba.",
          "\\(v_y=0\\) y \\(a_y=0\\).",
          "\\(v_y=g\\) y \\(a_y=0\\).",
          "la gravedad cambia de sentido."
        ],
        "answer": "A",
  ...
  "22": {
    ...
    "questions": [
      ...
      },
      {
        ...
        "options": [
          "El tiempo no cambia y el alcance se duplica.",
          "Ambos se duplican.",
          "El tiempo se reduce a la mitad y el alcance no cambia.",
          "Ambos permanecen iguales."
        ],
        "answer": "A",
      ...
      },
      {
        ...
        "type": "mcq",
        "difficulty": 2,
        "prompt": "Un pasajero camina a \\(1\\,\\mathrm{m/s}\\) hacia popa respecto de un barco que avanza a \\(4\\,\\mathrm{m/s}\\) hacia proa. Su velocidad respecto de la costa es...",
        "options": [
          "3 m/s hacia proa",
          "5 m/s hacia proa",
          "3 m/s hacia popa",
        ...
        "answer": "A",
        "explanation": "Tomando proa positiva: \\(v_{P/C}=-1+4=3\\,\\mathrm{m/s}\\)."
      },
      {
        "id": "CP_2D_004",
        "type": "mcq",
        ...
        "options": [
          "mono y proyectil sufren la misma caída gravitatoria durante el mismo intervalo.",
          "el proyectil no cae.",
          "el mono permanece inmóvil.",
          "la gravedad aumenta la velocidad horizontal."
        ],
        "answer": "A",
        "explanation": "Ambos reciben el mismo término vertical \\(\\frac{1}{2}gt^2\\)."
      },
      {
        "id": "CP_2D_005",
        "type": "mcq",
        "difficulty": 2,
        "prompt": "Si \\(v_{0x}=8\\,\\mathrm{m/s}\\) y \\(v_{0y}=10\\,\\mathrm{m/s}\\), ¿qué componente permanece constante en el proyectil ideal?",
        "options": [
          "\\(v_x\\)",
          "\\(v_y\\)",
          "ambas",
          "ninguna, porque g modifica ambas"
        ],
        "answer": "A",
    ...
    "questions": [
      {
        ...
        "type": "mcq",
        "difficulty": 2,
        "prompt": "Un disco gira con \\(T=0.50\\,\\mathrm{s}\\). ¿Cuál es su frecuencia?",
        "options": [
          "2 Hz",
          "0.5 Hz",
          "\\(2\\pi\\) Hz",
        ...
        "answer": "A",
        "explanation": "\\(f=\\frac{1}{T}=2\\,\\mathrm{Hz}\\)."
      },
      {
        "id": "CP_CIRC_002",
        "type": "mcq",
        ...
        "options": [
          "El punto a \\(2r\\) tiene el doble de rapidez tangencial.",
          "Ambos tienen la misma rapidez tangencial.",
          "El punto a \\(r\\) tiene el doble.",
          "No puede saberse porque no comparten ω."
        ],
        "answer": "A",
      ...
      },
      {
        ...
        "options": [
          "La centrípeta.",
          "La tangencial solamente.",
          "Ninguna.",
          "Una aceleración horizontal constante necesariamente."
        ],
        "answer": "A",
    ...
    "questions": [
      {
        ...
        "options": [
          "la rapidez es máxima y la aceleración es cero.",
          "la rapidez es cero y la aceleración máxima.",
          "x=A.",
          "la fase deja de cambiar."
        ],
        "answer": "A",
      ...
      },
      {
        ...
        "options": [
          "mayor frecuencia y mayor \\(\\omega\\).",
          "menor frecuencia y menor \\(\\omega\\).",
          "igual frecuencia.",
          "menor \\(\\omega\\) pero mayor f."
        ],
        "answer": "A",
        "explanation": "\\(f=\\frac{1}{T}\\) y \\(\\omega=2\\pi f\\)."
      },
      {
        "id": "CP_MAS_004",
        "type": "mcq",
