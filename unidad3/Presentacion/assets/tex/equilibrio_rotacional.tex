...
\draw[force,color=accentred] (-2.2,0)--(-2.2,-1.4) node[below] {$\vec F_1$};
\draw[force,color=accentgreen] (2.4,0)--(2.4,-1) node[below] {$\vec F_2$};
...
\node[lab] at (0,1.35) {$\sum\tau=0 \Rightarrow F_1r_1=F_2r_2$};
\end{tikzpicture}
